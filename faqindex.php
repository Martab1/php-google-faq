...
$faqs = [
    [
        ...
        "answer" => "La recente decisione della Corte di giustizia dell'Unione europea ha profonde conseguenze per i motori di ricerca in Europa.
             ...
             La decisione della CGUE rappresenta un cambiamento significativo per i motori di ricerca. Siamo preoccupati per le sue conseguenze, ma riteniamo anche che sia importante rispettare la decisione della Corte e ci stiamo adoperando per predisporre una procedura conforme alla legge.<br><br>
    ...
    [
        ...
        "answer" => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno. <br><br>
           ...
           Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel Centro Google per la sicurezza online. <br><br> Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo. <br><br>",
...
<header class="main-header ">
     <!-- HEADER TOP  -->
     <section class="header-top flex space">
         <!-- left -->
        <ul class="flex">
            <li> <img class="logo" src="./img/logo.png" alt="logo"> </li>
            <li> <a  class="privacy" href="#"> Privacy e termini</a></li>
        </ul>
         <!-- right -->
        <ul class="flex ">
            <li class="mr20"> <i class="fas fa-ellipsis-v"></i><i class="fas fa-ellipsis-v"></i><i class="fas fa-ellipsis-v"></i></li>
            <li> <img class="user" src="./img/download.jpeg" alt="user"> </li>
        </ul>
...
<main>
    ...
    <section class="container">
        <?php foreach ($faqs as $qa) {?>
            ...
            <h2 class="question"> <?php echo $qa["question"];'<br>' ?>   </h2>
            <p class="answer">  <?php echo $qa["answer"];'<br>' ?>  </p>
